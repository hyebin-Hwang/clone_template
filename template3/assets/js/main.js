...
const AgentSlider = (function(){
    ...
    agentFirstMq.addListener(handleFirstMatch);
    agentSecondMq.addListener(handleSecondMatch);
    agentThirdMq.addListener(handleThridMatch);
    agentFourthMq.addListener(handleFourthMatch);
